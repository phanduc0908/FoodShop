<%-- 
    Document   : adminlogin
    Created on : Nov 3, 2018, 10:07:25 AM
    Author     : Quang Hiep
--%>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default form-container">
                        <div class="panel-body">
                            <form action="AdminController" id="loginForm" method="POST">
                                <h2 class="text-center margin-xl-bottom">Đăng nhập</h2>
                                <div class="form-group text-center">
                                    <label class="sr-only" for="email">Tên đăng nhập</label>
                                    <input type="text" class="form-control input-lg" name="username" id="username" placeholder="Tên đăng nhập">
                                </div>
                                <div class="form-group text-center">
